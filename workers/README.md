...
- `NATURE_FILE_PATH=assets/nature/state.json`

Secrets:

- `ADMIN_PASSWORD=6476` (or your new admin password)
- `NATURE_EDIT_HASH=<sha-256 hex of the third nature edit password>`
...
- `the third nature.sys` sends only the SHA-256 hash to the Worker for edit access.
